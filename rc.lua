...
browser2   = "firefox"
gui_editor = "sublime"
gui_player = "spotify --ui.track_notifications_enabled=false"
graphics   = "gimp"
...
-- {{{ Tags
tags = {
   names = { " WEB ", " TERMINAL ", " FILES ", " MUSIC " },
...
wp_index = 2
wp_timeout  = 10000
wp_path = os.getenv("HOME") .. "/Pictures/"
...
globalkeys = awful.util.table.join(
    ...
    -- Dropdown terminal
    awful.key({ modkey,	          }, "y",      function () drop(terminal) end),
    ...
    awful.key({ modkey }, "w", function () awful.util.spawn(gui_player) end),
